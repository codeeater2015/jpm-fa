...
var KforceDetailModal = React.createClass({
        ...
        return (
            <Modal style={{ marginTop: "10px" }} keyboard={false} bsSize="lg" enforceFocus={false} backdrop="static" show={this.props.show} onHide={this.props.onHide}>
                <Modal.Header className="modal-header bg-blue-dark font-white" closeButton>
                    <Modal.Title>Kforce List</Modal.Title>
                </Modal.Header>
                <Modal.Body bsClass="modal-body overflow-auto">
                    ...
                    <KforceDetailDatatable ref="DetailDatatable" proId={this.props.proId} notify={this.props.notify} eventId={this.props.eventId}/>
                </Modal.Body>
            </Modal>
        );
    },
