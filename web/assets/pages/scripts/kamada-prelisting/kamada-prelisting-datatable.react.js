var KamadaPrelistingDatatable = React.createClass({
            ...
            <div className="bg-grey" style={{ padding : "20px" , borderRadius : "10px"}}>
                ...
                <div className="row ">
                    <div className="col-md-5">
                        <button type="button" className="btn btn-primary" onClick={this.openCreateModal}>Create new listing</button>
                    </div>
                </div>
                            ...
                            <table id="kforce_list_table" className="table table-condensed table-bordered" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th className="text-center">Prelisting Desc</th>
