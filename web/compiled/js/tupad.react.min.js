                                ...
                                React.createElement("div", {className: "row"}, 
                                    ...
                                    React.createElement("div", {className: "col-md-3"}, 
                                        React.createElement(FormGroup, {controlId: "formReleaseDate", validationState: this.getValidationState('releaseDate')}, 
                                            ...
                                            React.createElement("input", {type: "date", value: this.state.form.data.releaseDate, className: "input-md form-control", disabled: true})
                                        )
                                    )
                                ), 
                            ...
                            React.createElement("div", {className: "col-md-12"}, 
                                ...
                                React.createElement("div", {className: "row"}, 
                                    ...
                                    React.createElement("div", {className: "col-md-3"}, 
                                        React.createElement(FormGroup, {controlId: "formReleaseDate", validationState: this.getValidationState('releaseDate')}, 
                                            React.createElement(ControlLabel, null, " Release Date : "), 
                                            React.createElement("input", {type: "text", value: this.props.releaseDate, className: "input-md form-control", disabled: true})
                                        )
                                    )
                                ), 
