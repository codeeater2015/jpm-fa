                            ...
                            React.createElement("tbody", null, 
                                (summary != null && (self.state.municipalityNo == null || self.state.municipalityNo == '01')) ? (
                                    React.createElement("tr", {className: "text-center"}, 
                                        ...
                                        React.createElement("td", {rowSpan: 3}, summary.hierarchy_summary[0].total_no_profile), 
                                ...
                                (summary != null && (self.state.municipalityNo == null || self.state.municipalityNo == '16')) ? (
                                    React.createElement("tr", {className: "text-center"}, 
                                        ...
                                        React.createElement("td", null, summary.hierarchy_summary[2].total_tl), 
                                        React.createElement("td", null, summary.hierarchy_summary[2].total_k0), 
                                        React.createElement("td", null, summary.hierarchy_summary[2].total_k1), 
                                        React.createElement("td", null, summary.hierarchy_summary[2].total_k2), 
                                        React.createElement("td", null, summary.hierarchy_summary[2].total_no_pos), 
                                        React.createElement("td", null, 
