...
var HierarchyItemSwapModal = React.createClass({displayName: "HierarchyItemSwapModal",
    ...
    render: function () {
        ...
        return (
            React.createElement(Modal, {style: { marginTop: "10px"}, keyboard: false, bsSize: "md", enforceFocus: false, backdrop: "static", show: this.props.show, onHide: this.props.onHide}, 
                React.createElement(Modal.Header, {className: "modal-header bg-blue-dark font-white", closeButton: true}, 
                    React.createElement(Modal.Title, null, "Swap KFC Members")
                ), 
                React.createElement(Modal.Body, {bsClass: "modal-body overflow-auto"}, 
                    React.createElement("form", {id: "hierachy_swap_form", onSubmit: this.submit}, 
                        React.createElement("div", {className: "row"}, 
                            React.createElement("div", {className: "col-md-12"}, 
                                React.createElement(FormGroup, {controlId: "formCurrentProVoterId"}, 
                                    React.createElement(ControlLabel, null, "Current : "), 
                                    React.createElement("select", {id: "current-voter-swap-select2", className: "form-control input-sm"}
                                    ), 
                                    React.createElement(HelpBlock, null, this.getError('currentProVoterId'))
                                )
                            ), 
                            React.createElement("div", {className: "col-md-6"}, 
                                React.createElement(FormGroup, {controlId: "formProVoterId"}, 
                                    React.createElement(ControlLabel, null, "Position : "), 
                                    React.createElement("select", {id: "current-voter-group-select2", className: "form-control input-sm"}
                                    ), 
                                    React.createElement(HelpBlock, null, this.getError('proVoterId'))
                                )
                            ), 
                            React.createElement("div", {className: "col-md-12"}, 
                                React.createElement(FormGroup, {controlId: "formNewProVoterId"}, 
                                    React.createElement(ControlLabel, null, "New  : "), 
                                    React.createElement("select", {id: "new-voter-swap-select2", className: "form-control input-sm"}
                                    ), 
                                    React.createElement(HelpBlock, null, this.getError('newProVoterId'))
                                )
                            ), 
                            React.createElement("div", {className: "col-md-6"}, 
                                React.createElement(FormGroup, {controlId: "formProVoterId"}, 
                                    React.createElement(ControlLabel, null, "Position : "), 
                                    React.createElement("select", {id: "new-voter-group-select2", className: "form-control input-sm"}
                                    ), 
                                    React.createElement(HelpBlock, null, this.getError('proVoterId'))
                                )
                            )
        ...
        return (
            React.createElement(Modal, {style: { marginTop: "10px"}, keyboard: false, dialogClassName: "modal-custom-85", enforceFocus: false, backdrop: "static", show: this.props.show, onHide: this.props.onHide}, 
                ...
                React.createElement(Modal.Body, {bsClass: "modal-body overflow-auto"}, 
                    ...
                    React.createElement(HierarchyProfileDatatable, {ref: "DetailDatatable", proVoterId: this.props.proVoterId})
                )
            )
        );
    },
        ...
        return (
            React.createElement("div", {className: "portlet light portlet-fit bordered"}, 
                React.createElement("div", {className: "portlet-body", id: "bcbp_component"}, 
                        ...
                        React.createElement(HierarchyItemSwapModal, {
                            ...
                            selectedItem != null ? (
                                React.createElement("div", null, 
                                    React.createElement("div", null, 
                                        ...
                                        React.createElement("a", {onClick: this.openSwapModal, style: { marginLeft: "5px"}, href: "#", className: "btn btn-sm btn-primary m-btn m-btn--icon m-btn--icon-only"}, 
                                    ...
                                    React.createElement("div", null, React.createElement("strong", null, React.createElement("small", null, "Status :")), " ", Number.parseInt(selectedItem.voter.hasAttended) == 1 ? "Verified" : "Unverified", " "), 
                                    React.createElement("br", null), 
