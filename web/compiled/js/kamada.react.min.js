...
var KamadaEditModal = React.createClass({displayName: "KamadaEditModal",
    ...
    render : function(){
        ...
        return (
            React.createElement(Modal, {style: { marginTop : "10px"}, keyboard: false, bsSize: "lg", enforceFocus: false, backdrop: "static", show: this.props.show, onHide: this.props.onHide}, 
                React.createElement(Modal.Header, {className: "modal-header bg-blue-dark font-white", closeButton: true}, 
                    React.createElement(Modal.Title, null, "Edit Kamada Leader")
                ), 
                React.createElement(Modal.Body, {bsClass: "modal-body overflow-auto"}, 
                React.createElement("form", {id: "kamada-edit-form", onSubmit: this.submit}, 
                        React.createElement("div", {className: "row"}, 
                            React.createElement("div", {className: "col-md-3"}, 
                            ...
                            React.createElement("div", {className: "col-md-3"}, 
                                React.createElement(FormGroup, {controlId: "formPurok", validationState: this.getValidationState('purok')}, 
                                    ...
                                    React.createElement("select", {id: "purok_select2", className: "form-control form-filter input-sm", name: "purok"}
                                    ), 
    ...
    render: function () {
        ...
        return (
            React.createElement("div", null, 
                    ...
                    this.state.showEditModal &&
                    React.createElement(KamadaEditModal, {
                        proId: this.state.filters.proId, 
                        electId: self.state.filters.electId, 
                        provinceCode: this.state.filters.provinceCode, 
                        show: this.state.showEditModal, 
