 ...
 * PrelistingDetail
 *
 * @ORM\Table(name="tbl_pre_listing_dtl")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\PrelistingDetailRepository")
 * @UniqueEntity(fields={"hdrId","voterName"},message="This voter name already exists.", errorPath="voterName")
 */
class PrelistingDetail
{
     /**
     * @var int
     *
     ...
     * @var int
     *
     * @ORM\Column(name="group_no", type="integer")
     */
    private $groupNo;
     ...
     * @var int
     *
     * @ORM\Column(name="is_leader", type="integer")
     */
    private $isleader;
