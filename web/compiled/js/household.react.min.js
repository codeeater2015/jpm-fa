                        ...
                        React.createElement("table", {className: "table table-condensed table-bordered"}, 
                            React.createElement("thead", {style: { backgroundColor: "#5ab866"}}, 
                                React.createElement("tr", {className: "text-center"}, 
                                    React.createElement("th", {colSpan: "2", className: "text-center"}, "Voters"), 
                                    React.createElement("th", {rowSpan: "2", className: "text-center"}, "Outside"), 
                                    React.createElement("th", {colSpan: "2", className: "text-center"}, "Potential"), 
                                    React.createElement("th", {rowSpan: "2", className: "text-center"}, "Total Households")
                                ), 
                                React.createElement("tr", null, 
                            ...
                            React.createElement("tbody", null, 
                                summary != null ? (
                                    React.createElement("tr", {className: "text-center"}, 
                                        React.createElement("td", null, summary.voters[1].total_voter), 
                                        React.createElement("td", null, summary.voters[0].total_voter), 
                                        React.createElement("td", null, summary.total_voter_outside), 
                                        ...
                                        React.createElement("td", null, summary.total_household)
                                    )
                                ) : null
                            )
                        )
