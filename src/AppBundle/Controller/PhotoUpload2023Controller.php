...
/**
 * @Route("/photo-upload-2023")
 */

class PhotoUpload2023Controller extends Controller
{
    /**
     * @Route("", name="photo_upload_2023_index", options={"main" = true})
     */
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('template/photo-upload-2023/index.html.twig', ['user' => $user, 'hostIp' => $hostIp, 'imgUrl' => $imgUrl]);
    }
