        ...
        return (
            React.createElement(Modal, {style: { marginTop: "10px"}, keyboard: false, dialogClassName: "modal-custom-85", enforceFocus: false, backdrop: "static", show: this.props.show, onHide: this.props.onHide}, 
                React.createElement(Modal.Header, {className: "modal-header bg-blue-dark font-white", closeButton: true}, 
                    React.createElement(Modal.Title, null, "Hierarchy Profile Modal")
                ), 
                ...
                React.createElement("div", {className: "portlet-body", id: "bcbp_component"}, 
                    ...
                    React.createElement("div", {className: "row", id: "hierarchy_page"}, 
                        ...
                        React.createElement("div", {className: "col-md-6"}, 
                            React.createElement("div", {className: "row"}, 
                                React.createElement("div", {className: "col-md-12"}, 
                                    React.createElement("p", {className: "text-center"}, React.createElement("strong", null, this.state.form.data.voterGroupFilter, " HIERARCHY DISPLAY "))
                                )
                            ), 
                            React.createElement("div", {className: "row"}, 
                                React.createElement("div", {className: "col-md-12"}, 
                        ...
                        React.createElement("div", {className: "col-md-2"}, 
                            React.createElement("p", {className: "text-center"}, React.createElement("strong", null, "OVERVIEW")), 
                            selectedItem != null ? (
                                React.createElement("div", null, 
                                    React.createElement("div", null, 
                                        React.createElement("a", {onClick: this.openEditModal, href: "#", className: "btn btn-sm btn-danger m-btn m-btn--icon m-btn--icon-only"}, 
                                            "TL"
                                        ), 
                                    ...
                                    React.createElement("div", null, React.createElement("strong", null, "Contact # :"), "  ", selectedItem.contactNo, " "), 
                                    React.createElement("div", null, React.createElement("strong", null, "Position :"), " ", selectedItem.voterGroup, " ")
                                )
                            ) : ""
                        )
                    )
