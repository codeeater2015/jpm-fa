...
var HouseholdDatatable = React.createClass({displayName: "HouseholdDatatable",
    ...
    openHouseholdSummary : function(){
        this.setState({ showHouseholdSummary : true });
    },
                            ...
                            React.createElement("tbody", null, 
                                (summary != null && (self.state.municipalityNo == null || self.state.municipalityNo == '01')) ? (
                                    React.createElement("tr", {className: "text-center"}, 
                                        ...
                                        React.createElement("td", null, 
                                            React.createElement("button", {onClick: this.openHouseholdSummary, className: "btn btn-xs btn-primary btn-icon"}, React.createElement("i", {className: "fa fa-eye"}))
                                        )
                                    )
                                ) : null, 
